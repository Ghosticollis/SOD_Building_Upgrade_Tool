...
- all what you need to do is to copy the folder SodBuildingUpgrader to inside your server Modules folder.
- if server map is not vanilla map, not Limestone, and not Arid Reborn then you should create config file for your map so the module get to know what to upgrade to what. examples at config folder.
